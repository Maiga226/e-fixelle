...
import bf.e_fixell_backoffice.service.ClassificationService;
...
import bf.e_fixell_backoffice.service.ClassificationQueryService;
...
/**
 * REST controller for managing {@link bf.e_fixell_backoffice.domain.Classification}.
 */
@RestController
@RequestMapping("/api")
public class ClassificationResource {
    ...
    public ResponseEntity<ClassificationDTO> updateClassification(@RequestBody ClassificationDTO classificationDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, classificationDTO.getId().toString()))
            .body(result);
    }

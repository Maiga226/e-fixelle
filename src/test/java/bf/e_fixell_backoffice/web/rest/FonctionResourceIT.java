...
public class FonctionResourceIT {
    ...
    private static final Float DEFAULT_SALAIRE_MIN = 1F;
    private static final Float UPDATED_SALAIRE_MIN = 2F;

    private static final Float DEFAULT_SALAIRE_MAX = 1F;
    private static final Float UPDATED_SALAIRE_MAX = 2F;
    ...
    public void createFonction() throws Exception {
        ...
        assertThat(testFonction.getSalaireMin()).isEqualTo(DEFAULT_SALAIRE_MIN);
        assertThat(testFonction.getSalaireMax()).isEqualTo(DEFAULT_SALAIRE_MAX);
    }
    ...
    public void getAllFonctions() throws Exception {
        ...
        restFonctionMockMvc.perform(get("/api/fonctions?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].salaireMin").value(hasItem(DEFAULT_SALAIRE_MIN.doubleValue())))
            .andExpect(jsonPath("$.[*].salaireMax").value(hasItem(DEFAULT_SALAIRE_MAX.doubleValue())));
    }
    ...
    public void getFonction() throws Exception {
        ...
        restFonctionMockMvc.perform(get("/api/fonctions/{id}", fonction.getId()))
            ...
            .andExpect(jsonPath("$.salaireMin").value(DEFAULT_SALAIRE_MIN.doubleValue()))
            .andExpect(jsonPath("$.salaireMax").value(DEFAULT_SALAIRE_MAX.doubleValue()));
    }
    @Test
    @Transactional
    ...
    public void updateFonction() throws Exception {
        ...
        assertThat(testFonction.getSalaireMin()).isEqualTo(UPDATED_SALAIRE_MIN);
        assertThat(testFonction.getSalaireMax()).isEqualTo(UPDATED_SALAIRE_MAX);
    }
